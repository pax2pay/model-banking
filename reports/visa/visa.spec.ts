...
describe("VisaComponent", () => {
	const data: pax2pay.reports.visa.Data = pax2pay.reports.visa.Data.create(transactions, cards, {
		start: "2025-05-01",
		end: "2025-05-20",
	})
	it("should make visa report data", () => {
		const result: pax2pay.reports.visa.Data = {
			nonMonthly: {
				...
				"Number of Accounts - International Enabled": { "45672554": 1, "45672557": 1, "45672555": 1, totalIdx: 2 },
				"Total Number of Accounts": { "45672554": 1, "45672557": 1, "45672555": 1, totalIdx: 2 },
			...
			country: {
				DE: {
					notPresent: {
						1: { count: {}, volume: {} },
						2: {
							count: { "45672555": 1, "45672554": 1, totalIdx: 1 },
							volume: { "45672555": 1148.77, "45672554": 1148.77, totalIdx: 1148.77 },
						},
						3: { count: {}, volume: {} },
					},
				},
	...
	it("should make visa csv", () => {
		expect(pax2pay.reports.visa.toCsv(data)).toMatchInlineSnapshot(`
			...
			International - Intra-Regional Payments Count - Month 2|1|0|0|1|0|0|1
			...
			International - Intra-Regional Payments Volume - Month 2|1148.77|0|0|1148.77|0|0|1148.77
			...
			Total Number of Accounts|1|0|1|2|0|0|1
			Number of Accounts - Domestic Use Only|0|0|0|0|0|0|0
			Number of Accounts - International Enabled|1|0|1|2|0|0|1
			...
			Country DE - International - Intra-Regional Payments Card Not Present Count - Month 2|1|0|0|1|0|0|1
			...
			Country DE - International - Intra-Regional Payments Card Not Present Volume - Month 2|1148.77|0|0|1148.77|0|0|1148.77
...
const cards: pax2pay.Card[] = [
	{
		...
		reference: "zzzyP",
		status: "cancelled",
		details: { iin: "45672554", last4: "1111", expiry: [25, 6], holder: "Hej" },
		history: [{ type: "card", status: "cancelled", created: "2025-05-20T11:01:59.349Z" }],
		limit: ["GBP", 0],
		rules: [],
		spent: ["GBP", 414.15],
	},
	{
		...
		reference: "zzzyP",
		status: "cancelled",
		details: { iin: "45672557", last4: "1111", expiry: [25, 6], holder: "Hej" },
		history: [{ type: "card", status: "cancelled", created: "2025-05-20T11:01:59.349Z" }],
		limit: ["GBP", 0],
		rules: [],
		spent: ["GBP", 414.15],
	},
	{
		...
		status: "cancelled",
		details: { iin: "45672557", last4: "1111", expiry: [25, 6], holder: "Hej" },
		history: [{ type: "card", status: "cancelled", created: "2025-05-20T10:45:29.134Z" }],
		limit: ["GBP", 0],
		rules: [],
		spent: ["GBP", 477.74],
	},
	{
		...
		status: "cancelled",
		details: { iin: "45672557", last4: "1111", expiry: [25, 6], holder: "Hej" },
		history: [{ type: "card", status: "cancelled", created: "2025-05-21T10:30:45.005Z" }],
		limit: ["GBP", 0],
		rules: [],
		spent: ["GBP", 421.98],
	},
	{
		...
		reference: "zzzyPGA0",
		status: "cancelled",
		details: { iin: "45672555", last4: "1111", expiry: [25, 6], holder: "Hej" },
		history: [{ type: "card", status: "cancelled", created: "2025-05-19T10:30:45.005Z" }],
		limit: ["GBP", 0],
		rules: [],
		spent: ["GBP", 421.98],
	},
]
const transactions: pax2pay.Transaction.CardTransaction[] = [
	{
		amount: { original: -1148.77, total: -1148.77 },
		currency: "GBP",
