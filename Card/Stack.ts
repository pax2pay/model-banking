...
export namespace Stack {
	...
	export namespace Active {
		...
		export const typeZod: zod.ZodType<Active> = zod.enum([...test, ...uk])
	}
	...
	export namespace Decommissioned {
		...
		export const typeZod: zod.ZodType<Decommissioned> = zod.enum(values)
	}
	export const stacks = [...Active.values, ...Decommissioned.values] as const
	export const type = isly.string(stacks)
	export const typeZod: zod.ZodType<Stack> = zod.enum(stacks)
