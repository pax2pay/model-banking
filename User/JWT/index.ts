...
export class JWT {
	...
	private constructor(
		...
		readonly store?: storage.KeyValueStore<JWT>
	) {}
	...
	static open(key?: { private?: string; public?: string }, jwtStore?: storage.KeyValueStore<JWT>): JWT {
		return new this({ private: key?.private, public: key?.public ?? JWT.key }, jwtStore)
	}
}
